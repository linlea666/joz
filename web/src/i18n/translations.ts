...
export const translations = {
  en: {
    ...
    copytrade: {
      ...
      channelNotes: 'Channel Notes (optional)',
      channelNotesPlaceholder:
        "Trader style notes injected into the AI prompt, e.g. 'uses soft stops, entries as ranges'",
  ...
  zh: {
    ...
    copytrade: {
      ...
      channelNotes: '频道备注（可选）',
      channelNotesPlaceholder:
        '博主风格说明，会注入 AI 提示词，例如“习惯软止损、入场价常为区间”',
      riskMode: '仓位计算模式',
      riskByLoss: '以损定量',
      riskPercent: '资金百分比',
      riskFixed: '固定保证金',
